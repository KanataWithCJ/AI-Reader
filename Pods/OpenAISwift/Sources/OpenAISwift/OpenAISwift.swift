...
extension OpenAISwift {
    ...
    private func prepareRequest<BodyType: Encodable>(_ endpoint: Endpoint, body: BodyType) -> URLRequest {
        let urlComponents = URLComponents(url: URL(string: endpoint.baseURL() + endpoint.path)!, resolvingAgainstBaseURL: true)
...
//        }
        ...
        request.setValue("\(self.token!)", forHTTPHeaderField: "api-key")
